//$Id: radar3dviewer.cpp 14613 2013-11-04 20:48:49Z starviewer $

#include <QtOpenGL>

#include "radar3dviewer.h"

RADAR3dViewer::RADAR3dViewer(ColorTable *ct, NVOptions* opt)
             : RADAR2dViewer(ct, opt)
{
    int n;
...
void RADAR3dViewer::draw_isosurface()
{
...
void RADAR3dViewer::_advance_low_ray()
{
...
void RADAR3dViewer::_advance_up_ray()
{
...
void RADAR3dViewer::_replace_lower_sweep()
{
...
void RADAR3dViewer::_set_sweep_ray_ids()
{
    int n;
...
void RADAR3dViewer::_set_ray_param(int n)
{
...
void RADAR3dViewer::_advance_bin()
{
...
void RADAR3dViewer::_set_new_point()
{
    int idx = -1;
...
void RADAR3dViewer::_isosurface()
{
    int n;
    bool drawit = true;
