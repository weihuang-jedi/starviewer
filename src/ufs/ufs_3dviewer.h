#ifndef _UFS_3DVIEWER_H
#define _UFS_3DVIEWER_H
...
class UFS3dViewer : public QGLWidget
{

    public:
        UFS3dViewer(ColorTable* ct, NVOptions* opt);
        UFS3dViewer(ColorTable* ct, NVOptions* opt, const char* bmpflnm, ncReader* nchandler);
       ~UFS3dViewer();
    ...
    protected:
        ...
        void _lonlat2xyz(double lon, double lat, double radius,
                         double fact);
        void _xyVertex(double x, double y, double z, double fact);
