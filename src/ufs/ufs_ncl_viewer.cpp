//$Id: ufs_ncl_viewer.cpp 4927 2014-01-23 21:49:37Z starviewer $
...
UFS_NCL_Viewer::UFS_NCL_Viewer(ColorTable *ct, NVOptions* opt)
{
    colorTable = ct;
    nvoptions = opt;
  ...
  //earth = new Earth();
    contour = new UFS_Contour(colorTable);
...
void UFS_NCL_Viewer::_display_all()
{
...
void UFS_NCL_Viewer::_display_Xplane(int xs)
{
    float s1, t1, s2, t2;
...
void UFS_NCL_Viewer::_display_Yplane(int ys)
{
    float s1, t1, s2, t2;
...
void UFS_NCL_Viewer::_display_Zplane(int zs)
{
    float s1, t1, s2, t2;
...
void UFS_NCL_Viewer::_display_with_bump()
{
...
void UFS_NCL_Viewer::_display_Xplane_with_bump(int xs)
{
    int   j, k, m;
    float bs, bf;
    float delty, deltz;
...
void UFS_NCL_Viewer::_display_Yplane_with_bump(int ys)
{
    int   i, k, m;
    float bs, bf;
    float deltx, deltz;
...
void UFS_NCL_Viewer::_display_Zplane_with_bump(int zs)
{
    int   i, j, n;
    float bs, bf;
    float deltx, delty;
...
void UFS_NCL_Viewer::_display_on_height_surface()
{
    glScalef(1.0, 1.0, 0.4);
...
void UFS_NCL_Viewer::_display_Xplane_on_height_surface(int xs)
{
    int j, k, m;
    float* height = NULL;
    double* values = NULL;
...
void UFS_NCL_Viewer::_display_Yplane_on_height_surface(int ys)
{
    int i, k, m;
    float *height = NULL;
    double* values = NULL;
...
void UFS_NCL_Viewer::_display_Zplane_on_height_surface(int zs)
{
    int i, j, n;
    double* height = NULL;
    double* values = NULL;
...
void UFS_NCL_Viewer::_display_on_sphere()
{
    if(nz > 1)
    {
        if(nx > nvoptions->get_xsec())
...
void UFS_NCL_Viewer::_display_Xplane_on_sphere(int xs)
{
    int j, k, m, n;
    float* height = NULL;
    double* values = NULL;
...
void UFS_NCL_Viewer::_display_Yplane_on_sphere(int ys)
{
    int i, k, m, n;
    float* height = NULL;
    double* values = NULL;
...
void UFS_NCL_Viewer::_display_Zplane_on_sphere(int zs)
{
    int i, j, n;
    double* height = NULL;
    double* values = NULL;
...
void UFS_NCL_Viewer::_display_Global_on_sphere()
{
    int i, j;
...
void UFS_NCL_Viewer::_marchingCubeSetup()
{
  //Need to do nothing here.
}

void UFS_NCL_Viewer::set_geometry(UFS_Geometry *gm)
{
...
void UFS_NCL_Viewer::setup(string vn, double *var)
{
    size_t sz;
    Evaluator evaluator;
...
void UFS_NCL_Viewer::set_OP(bool s)
{
    _hasOP = s;
  //contour->reset();
}
...
void UFS_NCL_Viewer::_Vertex(float lon, float lat, float r, float s, float t)
{
...
void UFS_NCL_Viewer::_point(float x, float y, float z, float s, float t)
{
    glTexCoord2d(s, 1.0 - t);
    glVertex3f(x,y,z);
}

void UFS_NCL_Viewer::_xQuad(float x1, float y1, float z1, float y2, float z2,
...
void UFS_NCL_Viewer::_yQuad(float x1, float y1, float z1, float x2, float z2,
                    float s1, float t1, float s2, float t2)
{
    _point(x1, y1, z1, s1, t1);
...
void UFS_NCL_Viewer::_zQuad(float x1, float y1, float x2, float y2, float z2,
                    float s1, float t1, float s2, float t2)
{
...
void UFS_NCL_Viewer::set_opacity(int o)
{
  //cout << "Functions: <" << __PRETTY_FUNCTION__ << ">, line: " << __LINE__
  //     << ", file: <" << __FILE__ << ">" << endl;
  //cout << "\tOpacity = " << o << endl;
