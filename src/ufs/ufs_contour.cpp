...
#include "ufs_contour.h" // This likely includes QtOpenGL/Qt

//Constructor
UFS_Contour::UFS_Contour(ColorTable *ct)
{
    colorTable = ct;
...
void UFS_Contour::update_colormap()
{
    float *cmap = colorTable->get_cmap();
...
void UFS_Contour::_general_setup()
{
...
void UFS_Contour::_viewport_setup()
{
#ifdef USENCL
...
void UFS_Contour::_get_viewportXinfo()
{
#ifdef USENCL
 //cout << "\tEnter Functions: <" << __PRETTY_FUNCTION__ << ">, line: " << __LINE__ << ", file: <" << __FILE__ << ">" << endl;
...
void UFS_Contour::_viewportXsetup()
{
#ifdef USENCL
...
void UFS_Contour::_get_viewportYinfo()
{
#ifdef USENCL
  //cout << "\tEnter Functions: <" << __PRETTY_FUNCTION__ << ">, line: " << __LINE__ << ", file: <" << __FILE__ << ">" << endl;
    grlist = guiNhlRLCreate(NhlGETRL);
...
void UFS_Contour::_viewportYsetup()
{
#ifdef USENCL
...
void UFS_Contour::initialize_context()
{
#ifdef USENCL
  //cout << "\tEnter Functions: <" << __PRETTY_FUNCTION__ << ">, line: " << __LINE__ << ", file: <" << __FILE__ << ">" << endl;
...
unsigned int UFS_Contour::get_textureID()
{
...
void UFS_Contour::setup(string vn, double *var)
{
    size_t sz = 0;
    Evaluator evaluator;
...
unsigned int UFS_Contour::get_xid(int n)
{
    int j, k, m;
...
unsigned int UFS_Contour::get_yid(int n)
{
    int i, k, m;
...
unsigned int UFS_Contour::get_zid(int n)
{
    int i, j, k;
  ...
  //cout << "\tEnter Functions: <" << __PRETTY_FUNCTION__ << ">, line: " << __LINE__ << ", file: <" << __FILE__ << ">" << endl;
    ...
    if(n < _nz)
    {
      ...
      //Create a ContourPlot object, supplying the ScalarField object as data
        guiNhlRLClear(srlist);
        guiNhlRLSetInteger(srlist,(char *)NhlNcnScalarFieldData,dataid);
        guiNhlCreate(&cnid, "UFS_Contour", NhlcontourPlotClass, wksid, srlist);
...
void UFS_Contour::_get_viewport_info()
{
  //cout << "\tEnter Functions: <" << __PRETTY_FUNCTION__ << ">, line: " << __LINE__ << ", file: <" << __FILE__ << ">" << endl;
    if(grlist >= 0)
        guiNhlRLClear(grlist);
...
void UFS_Contour::_map_setup()
{
  ...
  //cout << "Functions: <" << __PRETTY_FUNCTION__ << ">, line: " << __LINE__ << ", file: <" << __FILE__ << ">" << endl;
  //cout << "\tThis for UFS model. map_proj = " << geometry->get_map_proj() << endl;
