//$Id: ufs_gl_viewer.cpp 5321 2015-02-20 03:20:52Z starviewer $
...
UFS_GL_Viewer::UFS_GL_Viewer(ColorTable *ct, NVOptions* opt)
{
    colorTable = ct;
    nvoptions = opt;
...
void UFS_GL_Viewer::scaleNtranslate()
{
...
void UFS_GL_Viewer::_parameter_setup()
{
    size_t sz;
    Evaluator evaluator;
...
void UFS_GL_Viewer::_display_all()
{
  //cout << "\tFunctions: <" << __PRETTY_FUNCTION__ << ">, line: " << __LINE__ << ", file: <" << __FILE__ << ">" << endl;
  //cout << "\tnvoptions->get_xsec() = " << nvoptions->get_xsec() << endl;
  //cout << "\tnvoptions->get_ysec() = " << nvoptions->get_ysec() << endl;
...
void UFS_GL_Viewer::_display_Xplane(int xs)
{
    int j, k, n;
    float f;
    float x1, y1, z1, z2;
...
void UFS_GL_Viewer::_display_Yplane(int ys)
{
    int i, k, n;
    float f;
    float x1, y1, z1, z2;
...
void UFS_GL_Viewer::_display_Zplane(int zs)
{
    int i, j, n;
    double *pltvar = NULL;
    float f;
...
void UFS_GL_Viewer::_display_with_bump()
{
    if((geometry->get_nx() > nvoptions->get_xsec()) && (geometry->get_nz() > 1))
    {
...
void UFS_GL_Viewer::_display_Xplane_with_bump(int xs)
{
    int j, k, n;
    float f;
    float amp = 0.2;
...
void UFS_GL_Viewer::_display_Yplane_with_bump(int ys)
{
    int i, k, n;
    float f;
    float amp = 0.2;
...
void UFS_GL_Viewer::_display_Zplane_with_bump(int zs)
{
    int i, j, n;
    double *pltvar = NULL;
    float f;
...
void UFS_GL_Viewer::_display_on_height_surface()
{
    if(geometry->get_nz() > 1)
    {
...
void UFS_GL_Viewer::_display_Xplane_on_height_surface(int xs)
{
    int j, k, n;
    float f;
    float x1, y1, z1, z2;
...
void UFS_GL_Viewer::_display_Yplane_on_height_surface(int ys)
{
    int i, k, n;
    float f;
    float x1, y1, z1, z2;
...
void UFS_GL_Viewer::_display_Zplane_on_height_surface(int zs)
{
    int i, j, n;
    double* height = NULL;
    float f;
...
void UFS_GL_Viewer::_display_on_sphere()
{
    if(geometry->get_nz() > 1)
    {
        if(geometry->get_nx() > nvoptions->get_xsec())
...
void UFS_GL_Viewer::_sphere1dVertex(float lon, float lat, float r, float f)
{
...
void UFS_GL_Viewer::_display_Xplane_on_sphere(int xs)
{
    int j, k, n;
    float f;
...
void UFS_GL_Viewer::_display_Yplane_on_sphere(int ys)
{
    int i, k, n;
    float f;
    float amp = 0.2 * zScale;
...
void UFS_GL_Viewer::_display_Zplane_on_sphere(int zs)
{
    int i, j, n;
    float f;
    float amp = 0.2 * zScale;
...
void UFS_GL_Viewer::set_geometry(UFS_Geometry *gm)
{
    geometry = gm;
}

void UFS_GL_Viewer::setup(string vn, double *var)
{
    _varname  = vn;
    _var = var;
...
void UFS_GL_Viewer::set_OP(bool s)
{
    _hasOP = s;
}

void UFS_GL_Viewer::set_opacity(int o)
{
  //cout << "Functions: <" << __PRETTY_FUNCTION__ << ">, line: " << __LINE__
  //     << ", file: <" << __FILE__ << ">" << endl;
  //cout << "\tOpacity = " << o << endl;
...
void UFS_GL_Viewer::saveDataset()
{
    FILE *outfl;
...
void UFS_GL_Viewer::_display_on_map()
{
    double height;
...
void UFS_GL_Viewer::_planeVertex(double lon, double lat, double height, double f)
{
...
void UFS_GL_Viewer::_display_Zplane_on_map(int zs)
{
    int i, j, n;
    double f;
    double height;
...
void UFS_GL_Viewer::_get_factor()
{
    int i, j, n;
...
void UFS_GL_Viewer::_display_on_sphere_map()
{
    double height;
...
void UFS_GL_Viewer::_display_Zplane_on_sphere_map(int zs)
{
    int i, j, n, n1, n2;
    double f;
    double height;
...
void UFS_GL_Viewer::update_colormap()
{
    texture1d->reset();
    texture1d->set_colors(colorTable->get_clen(), colorTable->get_cmap());
    texture1d->set_name(colorTable->get_name());
