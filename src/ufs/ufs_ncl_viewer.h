#ifndef _UFS_NCL_Viewer_H
#define _UFS_NCL_Viewer_H

//$Id: ufs_ncl_viewer.h 4833 2013-11-05 15:49:31Z starviewer $
...
class UFS_NCL_Viewer
{
    public:
        UFS_NCL_Viewer(ColorTable *ct, NVOptions* opt);
       ~UFS_NCL_Viewer();
        ...
        void set_geometry(UFS_Geometry *geometry);
