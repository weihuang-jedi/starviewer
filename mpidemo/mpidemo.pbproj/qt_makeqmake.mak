...
QMAKE    = /usr/bin/qmake
mpidemo.pbproj/project.pbxproj: mpidemo.pro  /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o mpidemo.pbproj/project.pbxproj mpidemo.pro
